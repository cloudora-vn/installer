...
TXT_PANEL_ALREADY_INSTALLED="O gerenciador de servidores CoraPanel Linux já está instalado, por favor não instale novamente."
TXT_SET_INSTALL_DIR="Definir o diretório de instalação padrão do CoraPanel. (O padrão é /opt): "
...
TXT_DOCKER_INSTALL_FAIL="A instalação do Docker falhou\nVocê pode tentar instalar o Docker usando um pacote offline. Consulte o link a seguir para obter etapas detalhadas de instalação: http://corapanel.cloudora.vn/installation/"
...
TXT_SET_PANEL_PORT="Definir porta do CoraPanel (o padrão é"
...
TXT_SET_PANEL_ENTRANCE="Definir entrada segura do CoraPanel (o padrão é"
...
TXT_SET_PANEL_USER="Definir usuário do painel CoraPanel (o padrão é"
...
TXT_SET_PANEL_PASSWORD="Definir senha do painel CoraPanel, pressione Enter para continuar após definir (o padrão é"
...
TXT_CONFIGURE_PANEL_SERVICE="Configurando o serviço CoraPanel"
TXT_START_PANEL_SERVICE="Iniciando o serviço CoraPanel"
TXT_PANEL_SERVICE_START_SUCCESS="O serviço CoraPanel foi iniciado com sucesso. Continuando com as configurações finais, por favor, aguarde..."
TXT_PANEL_SERVICE_START_ERROR="Erro ao iniciar o serviço CoraPanel!"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Site oficial: http://corapanel.cloudora.vn"
TXT_PROJECT_DOCUMENTATION="Documentação do projeto: http://corapanel.cloudora.vn"
TXT_PROJECT_REPOSITORY="Repositório de código: https://github.com/cloudora-vn/corapanel"
TXT_COMMUNITY="Junte-se à comunidade do CoraPanel no Discord para suporte e discussões: https://discord.gg/bUpUqWqdRr"
...
TXT_PANEL_SERVICE_STATUS="Verificar status do serviço CoraPanel"
TXT_PANEL_SERVICE_RESTART="Reiniciar serviço CoraPanel"
TXT_PANEL_SERVICE_STOP="Parar serviço CoraPanel"
TXT_PANEL_SERVICE_START="Iniciar serviço CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL="Desinstalar serviço CoraPanel"
TXT_PANEL_SERVICE_USER_INFO="Obter informações do usuário do CoraPanel"
TXT_PANEL_SERVICE_LISTEN_IP="Trocar IP de escuta do CoraPanel"
TXT_PANEL_SERVICE_VERSION="Obter informações da versão do CoraPanel"
TXT_PANEL_SERVICE_UPDATE="Atualizar sistema CoraPanel"
TXT_PANEL_SERVICE_RESET="Redefinir sistema CoraPanel"
TXT_PANEL_SERVICE_RESTORE="Restaurar sistema CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL_NOTICE="A desinstalação irá parar e remover o serviço do CoraPanel. Continuar? [y/n]: "
TXT_PANEL_SERVICE_UNINSTALL_START="Iniciando a desinstalação do painel de gerenciamento de servidores Linux CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL_STOP="Parando os processos do serviço CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL_REMOVE="Removendo arquivos executáveis do CoraPanel e configurações relacionadas ao serviço"
...
TXT_PANEL_DATA_KEEP_PROMPT="Excluir diretório de dados do CoraPanel? [y/n]: "
TXT_PANEL_DATA_KEEP="Manter diretório de dados do CoraPanel"
TXT_PANEL_DATA_DELETE="Excluir diretório de dados do CoraPanel"
TXT_PANEL_SERVICE_RESTORE_NOTICE="O CoraPanel será restaurado para a última versão estável. Deseja continuar? [y/n]: "
TXT_PANEL_SERVICE_UNSUPPORTED_PARAMETER="Parâmetros não suportados, use help ou o parâmetro --help para obter ajuda"
TXT_PANEL_CONTROL_SCRIPT="Script de controle do CoraPanel"
