...
TXT_PANEL_ALREADY_INSTALLED="CoraPanel Linux server management panel is already installed, please do not install again"
TXT_SET_INSTALL_DIR="Set CoraPanel installation directory (default is /opt): "
...
TXT_DOCKER_INSTALL_FAIL="Docker installation failed\nYou may try installing Docker using an offline package, refer to the following link for detailed installation steps: http://corapanel.cloudora.vn/docs/installation/"
...
TXT_SET_PANEL_PORT="Set CoraPanel port (default is"
...
TXT_SET_PANEL_ENTRANCE="Set CoraPanel secure entrance (default is"
...
TXT_SET_PANEL_USER="Set CoraPanel panel user (default is"
...
TXT_SET_PANEL_PASSWORD="Set CoraPanel panel password, press Enter to continue after setting (default is"
TXT_INPUT_PASSWORD_RULE="Error: Panel password only supports letters, numbers, special characters (!@#$%*_,.?), length 8-30 characters"
TXT_CONFIGURE_PANEL_SERVICE="Configuring CoraPanel Service"
TXT_START_PANEL_SERVICE="Starting CoraPanel service"
TXT_PANEL_SERVICE_START_SUCCESS="CoraPanel service has started successfully. Continuing with post-setup tasks, please wait..."
TXT_PANEL_SERVICE_START_ERROR="Error starting CoraPanel service!"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Official website: http://corapanel.cloudora.vn"
TXT_PROJECT_DOCUMENTATION="Project documentation: http://corapanel.cloudora.vn/docs"
TXT_PROJECT_REPOSITORY="Code repository: https://github.com/cloudora-vn/corapanel"
TXT_COMMUNITY="Join the CoraPanel community on Discord for support and discussions: https://discord.gg/bUpUqWqdRr"
...
TXT_PANEL_SERVICE_STATUS="Check CoraPanel service status"
TXT_PANEL_SERVICE_RESTART="Restart CoraPanel service"
TXT_PANEL_SERVICE_STOP="Stop CoraPanel service"
TXT_PANEL_SERVICE_START="Start CoraPanel service"
TXT_PANEL_SERVICE_UNINSTALL="Uninstall CoraPanel service"
TXT_PANEL_SERVICE_USER_INFO="Get CoraPanel user information"
TXT_PANEL_SERVICE_LISTEN_IP="Switch CoraPanel listening IP"
TXT_PANEL_SERVICE_VERSION="Get CoraPanel version information"
TXT_PANEL_SERVICE_UPDATE="Update CoraPanel system"
TXT_PANEL_SERVICE_RESET="Reset CoraPanel system"
TXT_PANEL_SERVICE_RESTORE="Restore CoraPanel system"
TXT_PANEL_SERVICE_UNINSTALL_NOTICE="Uninstallation will stop and remove the CoraPanel service. Continue? [y/n]: "
TXT_PANEL_SERVICE_UNINSTALL_START="Starting to uninstall CoraPanel Linux Server Management Panel"
TXT_PANEL_SERVICE_UNINSTALL_STOP="Stopping CoraPanel service processes"
TXT_PANEL_SERVICE_UNINSTALL_REMOVE="Removing CoraPanel executables and service-related configurations"
...
TXT_PANEL_DATA_KEEP_PROMPT="Delete CoraPanel data directory? [y/n]: "
TXT_PANEL_DATA_KEEP="Keep CoraPanel data directory"
TXT_PANEL_DATA_DELETE="Delete CoraPanel data directory"
TXT_PANEL_SERVICE_RESTORE_NOTICE="CoraPanel will be restored to the last stable version. Do you want to continue? [y/n]: "
TXT_PANEL_SERVICE_UNSUPPORTED_PARAMETER="Unsupported parameters, please use help or --help parameter to get help"
TXT_PANEL_CONTROL_SCRIPT="CoraPanel control script"
