...
TXT_PANEL_ALREADY_INSTALLED="Панель управления CoraPanel уже установлена, повторная установка невозможна"
TXT_SET_INSTALL_DIR="Укажите директорию для установки CoraPanel (по умолчанию /opt): "
...
TXT_DOCKER_INSTALL_FAIL="Установка Docker не удалась\nВы можете попробовать установить Docker, используя оффлайн-пакет, обратитесь к следующей ссылке для подробных инструкций: http://corapanel.cloudora.vn/installation/"
...
TXT_SET_PANEL_PORT="Установите порт CoraPanel (по умолчанию"
...
TXT_SET_PANEL_ENTRANCE="Установите безопасный вход CoraPanel (по умолчанию"
...
TXT_SET_PANEL_USER="Установите пользователя панели CoraPanel (по умолчанию"
...
TXT_SET_PANEL_PASSWORD="Установите пароль панели CoraPanel, нажмите Enter после установки (по умолчанию"
TXT_INPUT_PASSWORD_RULE="Ошибка: Пароль панели поддерживает только буквы, цифры, специальные символы (!@#$%*_,.?), длина 8-30 символов"
TXT_CONFIGURE_PANEL_SERVICE="Настройка службы CoraPanel"
TXT_START_PANEL_SERVICE="Запуск службы CoraPanel"
TXT_PANEL_SERVICE_START_SUCCESS="Служба CoraPanel успешно запущена. Продолжается выполнение последующих настроек, пожалуйста, подождите..."
TXT_PANEL_SERVICE_START_ERROR="Ошибка запуска службы CoraPanel!"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Официальный сайт: http://corapanel.cloudora.vn"
TXT_PROJECT_DOCUMENTATION="Документация проекта: http://corapanel.cloudora.vn"
TXT_PROJECT_REPOSITORY="Репозиторий кода: https://github.com/cloudora-vn/corapanel"
TXT_COMMUNITY="Присоединяйтесь к сообществу CoraPanel в Discord для поддержки и обсуждений: https://discord.gg/bUpUqWqdRr"
...
TXT_PANEL_SERVICE_STATUS="Проверить статус службы CoraPanel"
TXT_PANEL_SERVICE_RESTART="Перезапустить службу CoraPanel"
TXT_PANEL_SERVICE_STOP="Остановить службу CoraPanel"
TXT_PANEL_SERVICE_START="Запустить службу CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL="Удалить службу CoraPanel"
TXT_PANEL_SERVICE_USER_INFO="Получить информацию о пользователе CoraPanel"
TXT_PANEL_SERVICE_LISTEN_IP="Переключить IP прослушивания CoraPanel"
TXT_PANEL_SERVICE_VERSION="Получить информацию о версии CoraPanel"
TXT_PANEL_SERVICE_UPDATE="Обновить систему CoraPanel"
TXT_PANEL_SERVICE_RESET="Сбросить систему CoraPanel"
TXT_PANEL_SERVICE_RESTORE="Восстановить систему CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL_NOTICE="Удаление остановит и удалит службу CoraPanel. Продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNINSTALL_START="Начало удаления панели управления сервером CoraPanel для Linux"
TXT_PANEL_SERVICE_UNINSTALL_STOP="Остановка процессов службы CoraPanel"
TXT_PANEL_SERVICE_UNINSTALL_REMOVE="Удаление исполняемых файлов CoraPanel и связанных конфигураций службы"
...
TXT_PANEL_DATA_KEEP_PROMPT="Удалить каталог данных CoraPanel? [y/n]: "
TXT_PANEL_DATA_KEEP="Сохранить каталог данных CoraPanel"
TXT_PANEL_DATA_DELETE="Удалить каталог данных CoraPanel"
TXT_PANEL_SERVICE_RESTORE_NOTICE="CoraPanel будет восстановлен до последней стабильной версии. Хотите продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNSUPPORTED_PARAMETER="Неподдерживаемые параметры, используйте help или --help для получения справки"
TXT_PANEL_CONTROL_SCRIPT="Скрипт управления CoraPanel"
