...
EOF
    ...
    # Replace placeholders in corapctl - make sure BASE_DIR is on its own line
    ...
    # Also create a simple config file that corapanel-core can read
    ${SUDO} cat > ${INSTALL_DIR}/.env <<EOF
